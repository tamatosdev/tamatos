    ...
    <main style={{ overflowX: "clip" }}>
      <section className="relative pt-32 pb-10 lg:pt-40 lg:pb-14 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div
            className="inline-flex w-fit items-center gap-2 px-5 py-2 rounded-full text-[16px] sm:text-[18px] text-white/70 font-medium mb-8"
            style={{
      ...
      {item.body && item.body.length > 0 && (
        <section className="container pb-12 lg:pb-16">
          <div
            ...
            style={{ fontSize: "clamp(18px, 1.1vw, 18px)", lineHeight: 1.7 }}
          >
