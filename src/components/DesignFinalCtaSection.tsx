...
export default function DesignFinalCtaSection() {
  return (
    <section className="relative overflow-x-clip py-16 lg:py-28">
      ...
      <div className="container relative z-10">
        <div className="relative overflow-hidden rounded-[28px] bg-white px-6 py-10 lg:rounded-[40px] lg:px-[70px] lg:py-[70px]">
          {/* Inner card shade — same placement as home CTA so glow soft-fades inside */}
          <Image
            src={ctaImage}
            alt=""
          ...
          <div className="relative z-10 max-w-[820px]">
            ...
            <p
              className="mt-6 max-w-[560px] font-medium leading-[1.55] tracking-[-0.02em] text-[#0A0A0C]/75"
              style={{ fontSize: "clamp(15px, 1.15vw, 16px)" }}
            >
              Whether you&apos;re launching something new or redefining an existing business,
              we&apos;ll help you build a brand that earns trust, creates recognition, and
