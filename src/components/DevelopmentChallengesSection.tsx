  ...
  return (
    <section className="relative overflow-x-clip py-20 lg:py-28">
      <div className="container relative">
        ...
        <Link
          href="/contact"
          className="mt-10 inline-flex items-center justify-center rounded-full bg-[var(--service-accent,#FC7031)] py-3 px-7 text-[18px] font-medium leading-none tracking-[-0.03em] text-[#0A0A0C] transition-colors duration-300 hover:bg-white lg:mt-14 lg:px-8 lg:py-4 lg:text-[18px]"
        >
