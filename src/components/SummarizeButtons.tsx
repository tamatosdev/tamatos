...
export default function SummarizeButtons({ title, slug }: Props) {
  ...
  const iconClass =
    "text-white/50 hover:text-white transition-colors duration-200 inline-flex items-center justify-center";
  ...
  return (
    <div className="flex items-center gap-3 relative">
      ...
      >
        <svg fill="currentColor" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
