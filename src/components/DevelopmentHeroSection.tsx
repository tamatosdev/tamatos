        ...
        <div className="mt-8 grid items-center gap-8 lg:mt-14 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <div className="mt-8 flex flex-col items-start gap-5 sm:mt-10 sm:flex-row sm:flex-wrap sm:items-center sm:gap-8">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-full bg-white py-3 px-7 text-[15px] font-medium leading-none tracking-[-0.03em] text-[#0A0A0C] transition-colors duration-300 hover:bg-[var(--service-accent,#FC7031)] lg:px-8 lg:py-4 lg:text-[16px]"
              >
