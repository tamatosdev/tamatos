...
import orangeNabeel from "@/assets/orange-nabeel.png";
import ctaShade from "@/assets/cta-2-shadow.png";
import ctaShadeMobile from "@/assets/cta-shade-mobile.png";

export default function DevelopmentQuoteCtaSection() {
  return (
      ...
      <div className="container relative">
        <div className="relative overflow-hidden rounded-[28px] bg-white px-6 py-10 lg:rounded-[40px] lg:px-14 lg:py-14">
          ...
          <div className="relative z-10">
            ...
            >
              <p>
                I&apos;ve seen businesses invest heavily in technology that looks impressive but
                doesn&apos;t solve the problems that matter.
              </p>
              <p className="mt-5 italic text-[#0A0A0C]">
                <span className="font-normal text-[#0A0A0C]/55">At Tamatos,</span> We believe
                development should make your business simpler, faster, and easier to grow, not more
                complicated. That&apos;s the mindset we bring to every project.
              </p>
            </div>

            <div className="mt-10 flex flex-col gap-6 lg:mt-14 lg:flex-row lg:items-center lg:gap-8">
              <div className="flex shrink-0 items-center gap-3.5">
                <div className="overflow-hidden rounded-full ring-2 ring-[var(--service-accent,#FC7031)] ring-offset-0">
                  <Image
                    src={orangeNabeel}
              ...
              >
                <span className="inline-flex items-center justify-center rounded-full bg-[var(--service-accent,#FC7031)] px-7 py-3.5 text-[16px] font-medium leading-none tracking-[-0.03em] text-[#0A0A0C] transition-colors duration-300 group-hover:bg-[#0A0A0C] group-hover:text-white lg:px-8 lg:text-[16px]">
                  Book a Strategy Session
                </span>
                <span className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#0A0A0C] text-white transition-colors duration-300 group-hover:bg-[var(--service-accent,#FC7031)] group-hover:text-[#0A0A0C]">
