        ...
        <div className="relative overflow-hidden rounded-[28px] bg-white px-6 py-10 lg:rounded-[40px] lg:px-14 lg:py-14">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 flex flex-col gap-6 lg:mt-14 lg:flex-row lg:items-center lg:gap-8">
              ...
              >
                <span className="inline-flex items-center justify-center rounded-full bg-[var(--service-accent,#FC7031)] px-7 py-3.5 text-[18px] font-medium leading-none tracking-[-0.03em] text-[#0A0A0C] transition-colors duration-300 group-hover:bg-[#0A0A0C] group-hover:text-white lg:px-8 lg:text-[18px]">
