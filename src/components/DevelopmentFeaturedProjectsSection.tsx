    ...
    >
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 lg:gap-8">
        ...
        <div className="flex flex-col justify-end gap-8 pb-2 lg:order-4 lg:gap-10 lg:pb-4 lg:pr-2">
          ...
          <Link
            href={project.href}
            className="group inline-flex w-fit items-center gap-2.5 text-[18px] font-medium tracking-[-0.02em] text-white transition-colors duration-200 hover:text-[var(--service-accent,#FC7031)] lg:text-[17.78px]"
          >
